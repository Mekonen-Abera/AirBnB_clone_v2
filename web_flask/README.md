...
| 7. Improve engines | [file_storage.py], [db_storage.py](./) |
| 8. List of states | [](./) |
| 9. Cities by states | [7-states_list.py](./) |
| 10. States and State | [8-cities_by_states.py](./) |
| 11. HBNB filters | [9-states.py](./) |
| 12. HBNB is alive! | [10-hbnb_filters.py](./) |
